                                    ...
                                    <div class="col-md-4 widget-area">
                                        <div class="featured-box text-center">
                                            <div class="featured-content">
                                                ...
                                                <div class="featured-desc">
                                                    <p>+962 778091889 or +962 77569482</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-8">
                                        <form id="subscribe-form" class="newsletter-form" method="post" action="#" data-mailchimp="true">
                                            <div class="mailchimp-inputbox clearfix" id="subscribe-content"> 
                                                ...
                                                <p>
                                                <button class="submit ttm-btn ttm-btn-size-sm ttm-btn-shape-rounded ttm-btn-style-fill ttm-btn-color-skincolor ttm-icon-btn-right" type="submit">Submit<i class="ti ti-arrow-right"></i></button>
                                                </p>
                                            </div>
                                ...
                                <div class="social-icons circle social-hover">
                                    <ul class="list-inline">
                                        ...
                                        <li class="social-twitter">
                                            <a class="tooltip-top" target="_blank" href="#" data-tooltip="Instagram">
                                                <i class="fa fa-instagram" aria-hidden="true"></i>
                                            </a>
                                        </li>
                                        <li class="social-flickr">
                                            <a class=" tooltip-top" target="_blank" href="#" data-tooltip="Whatsapp">
                                                <i class="fa fa-whatsapp" aria-hidden="true"></i>
                                            </a>
                                        </li>
                                        <li class="social-linkedin">
                                            <a class=" tooltip-top" target="_blank" href="#" data-tooltip="Mail">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 widget-area">
                            <div class="widget widget_nav_menu clearfix">
                                ...
                                <ul class="menu-footer-services">
                                    ...
                                    <li><a href="#">Pyment type you accept</a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row copyright">
                        <div class="col-md-12">
                            <div class="text-center">
                                <span>Copyright ©2020.&nbsp;All rights reserved by &nbsp;<a href="https://themetechmount.com/" target="_blank">Wedco.</a></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from www.themetechmount.in/html/wedco/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Aug 2022 23:32:28 GMT -->
</html>